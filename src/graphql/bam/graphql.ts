...
export type GetParticipantWeightInputQuery = { bapp?: { bAppTokens: Array<{ token: Address, sharedRiskLevel: string, totalObligatedBalance: string }>, strategies: Array<{ obligations: Array<{ obligatedBalance: string, token: Address, percentage: string }>, strategy: { id: string, owner: { id: Address, delegators: Array<{ percentage: string, id: string }> }, balances: Array<{ token: Address, riskValue: string }> } }> } | null };
