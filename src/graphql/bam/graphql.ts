...
export type GetObligatedBalancesQuery = { bapp?: { bAppTokens: Array<{ totalObligatedBalance: string, token: Address }>, strategies: Array<{ id: string, obligations: Array<{ token: Address, obligatedBalance: string }> }> } | null };
