...
export type GetStrategyBAppOptInsQuery = {
  strategyBAppOptIns: Array<{
    id: string
    strategy: { balances: Array<{ token: Address; balance: string }> }
    obligations: Array<{ token: Address; percentage: string }>
  }>
}
...
export type GetParticipantWeightInputQuery = {
  bapp?: {
    bAppTokens: Array<{ token: Address; sharedRiskLevel: string; totalObligatedBalance: string }>
    strategies: Array<{
      obligations: Array<{ obligatedBalance: string; token: Address; percentage: string }>
      strategy: {
        id: string
        owner: {
          id: Address
          delegators: Array<{ percentage: string; delegator: { id: Address } }>
        }
        balances: Array<{ token: Address; riskValue: string }>
      }
    }>
  } | null
}
...
export type GetObligatedBalancesQuery = {
  bapp?: {
    bAppTokens: Array<{ totalObligatedBalance: string; token: Address }>
    strategies: Array<{
      strategy: { id: string }
      obligations: Array<{ token: Address; obligatedBalance: string }>
    }>
  } | null
}
...
export type GetBAppDelegatorsQuery = {
  bapp?: {
    strategies: Array<{
      strategy: {
        id: string
        owner: { delegators: Array<{ percentage: string; delegator: { id: Address } }> }
      }
    }>
  } | null
}
...
export type GetAllBappsMetadataUrIsQuery = {
  bapps: Array<{ id: Address; metadataURI?: string | null }>
}
...
export type GetAllStrategyObligatedBalancesForBappQuery = {
  bapp?: {
    strategies: Array<{ strategy: { balances: Array<{ balance: string; token: Address }> } }>
  } | null
}
...
export type GetDepositedBalancesForStrategyQuery = {
  strategy?: {
    deposits: Array<{ depositAmount: string; token: Address; contributor: { id: Address } }>
  } | null
}
...
export type GetAllStrategiesDepositedToQuery = {
  account?: {
    deposits: Array<{
      ...
      token: Address
      strategy: { id: string; balances: Array<{ balance: string; token: Address }> }
    }>
  } | null
}
...
export type GetTotalDelegatedPercentageForAccountQuery = {
  account?: { totalDelegatedPercentage: string } | null
}
...
export type GetAllStrategiesForBappQuery = {
  bapp?: { strategies: Array<{ strategy: { id: string } }> } | null
}
...
export type GetAllStrategiesForAccountQuery = {
  account?: {
    strategies: Array<{ id: string; balances: Array<{ balance: string; token: Address }> }>
  } | null
}

export const GetStrategyBAppOptInsDocument = {
  kind: 'Document',
  definitions: [
    {
...
} as unknown as DocumentNode<GetStrategyBAppOptInsQuery, GetStrategyBAppOptInsQueryVariables>
export const GetParticipantWeightInputDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
  ...
  GetParticipantWeightInputQuery,
  GetParticipantWeightInputQueryVariables
>
export const GetObligatedBalancesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetObligatedBalancesQuery, GetObligatedBalancesQueryVariables>
export const GetBAppDelegatorsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetBAppDelegatorsQuery, GetBAppDelegatorsQueryVariables>
export const GetValidatorsByAccountDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetValidatorsByAccountQuery, GetValidatorsByAccountQueryVariables>
export const GetBappMetadataUriDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetBappMetadataUriQuery, GetBappMetadataUriQueryVariables>
export const GetAllBappsMetadataUrIsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetAllBappsMetadataUrIsQuery, GetAllBappsMetadataUrIsQueryVariables>
export const GetAllStrategyObligatedBalancesForBappDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
  ...
  GetAllStrategyObligatedBalancesForBappQuery,
  GetAllStrategyObligatedBalancesForBappQueryVariables
>
export const GetDepositedBalancesForStrategyDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
  ...
  GetDepositedBalancesForStrategyQuery,
...
export const GetAllStrategiesDepositedToDocument = {
  ...
  GetAllStrategiesDepositedToQuery,
  GetAllStrategiesDepositedToQueryVariables
>
export const GetTotalDelegatedPercentageForAccountDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
  ...
  GetTotalDelegatedPercentageForAccountQuery,
  GetTotalDelegatedPercentageForAccountQueryVariables
>
export const GetAllStrategiesForBappDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
} as unknown as DocumentNode<GetAllStrategiesForBappQuery, GetAllStrategiesForBappQueryVariables>
export const GetAllStrategiesForAccountDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
  ...
  GetAllStrategiesForAccountQuery,
