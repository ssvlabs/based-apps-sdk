...
export type GetParticipantWeightInputQuery = { bapp?: { bAppTokens: Array<{ token: Address, sharedRiskLevel: string, totalObligatedBalance: string }>, strategies: Array<{ obligations: Array<{ obligatedBalance: string, token: Address, percentage: string }>, strategy: { id: string, owner: { id: Address, delegators: Array<{ percentage: string, delegator: { id: Address } }> }, balances: Array<{ token: Address, riskValue: string }> } }> } | null };
...
export type GetObligatedBalancesQuery = { bapp?: { bAppTokens: Array<{ totalObligatedBalance: string, token: Address }>, strategies: Array<{ strategy: { id: string }, obligations: Array<{ token: Address, obligatedBalance: string }> }> } | null };
...
export type GetBappMetadataUriQuery = { bapp?: { metadataURI?: string | null } | null };

export type GetAllBappsMetadataUrIsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllBappsMetadataUrIsQuery = { bapps: Array<{ id: Address, metadataURI?: string | null }> };
...
export type GetAllStrategyObligatedBalancesForBappQuery = { bapp?: { strategies: Array<{ strategy: { balances: Array<{ balance: string, token: Address }> } }> } | null };
...
export type GetDepositedBalancesForStrategyQuery = { strategy?: { deposits: Array<{ depositAmount: string, token: Address, contributor: { id: Address } }> } | null };
...
export type GetAllStrategiesDepositedToQuery = { account?: { deposits: Array<{ depositAmount: string, token: Address, strategy: { id: string, balances: Array<{ balance: string, token: Address }> } }> } | null };
...
export type GetTotalDelegatedPercentageForAccountQuery = { account?: { totalDelegatedPercentage: string } | null };
...
export type GetAllStrategiesForBappQuery = { bapp?: { strategies: Array<{ strategy: { id: string } }> } | null };
...
export type GetAllStrategiesForAccountQuery = { account?: { strategies: Array<{ id: string, balances: Array<{ balance: string, token: Address }> }> } | null };
