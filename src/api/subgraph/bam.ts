...
export const getAllBappsMetadataURIs = (client: GraphQLClient) =>
  client
    .request(GetAllBappsMetadataUrIsDocument)
    .then((res: GetAllBappsMetadataUrIsQuery) => res.bapps)
...
export const getTotalDelegatedPercentageForAccount = (
  ...
  client
    .request(GetTotalDelegatedPercentageForAccountDocument, args)
    .then((res) => res.account?.totalDelegatedPercentage)
...
export const getAllStrategiesForBapp = (
  ...
  client
    .request(GetAllStrategiesForBappDocument, args)
    .then((res) => res.bapp?.strategies.map((strategyInfo) => strategyInfo.strategy.id) || [])
...
export const getAllStrategiesForAccount = (
  ...
  client
    .request(GetAllStrategiesForAccountDocument, args)
    .then((res) => res.account?.strategies || [])
...
export const getBAMQueries = (client: GraphQLClient) => ({
  ...
  getAllStrategyObligatedBalancesForBapp: getAllStrategyObligatedBalancesForBapp.bind(
    null,
    client,
  ) as RemoveConfigArg<typeof getAllStrategyObligatedBalancesForBapp>,
  getDepositedBalancesForStrategy: getDepositedBalancesForStrategy.bind(
    null,
    client,
  ) as RemoveConfigArg<typeof getDepositedBalancesForStrategy>,
  ...
  getTotalDelegatedPercentageForAccount: getTotalDelegatedPercentageForAccount.bind(
    null,
    client,
  ) as RemoveConfigArg<typeof getTotalDelegatedPercentageForAccount>,
